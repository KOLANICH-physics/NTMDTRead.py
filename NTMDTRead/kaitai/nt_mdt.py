    ...
    class Frame(KaitaiStruct):
        ...
        class FrameMain(KaitaiStruct):
            ...
            def _read(self):
                ...
                if _on == self._root.Frame.FrameType.scanned:
                    ...
                    self.frame_data = self._root.Frame.FrameMain.Scanned(io, self, self._root)
                elif _on == self._root.Frame.FrameType.curves_new:
                    self._raw_frame_data = self._io.read_bytes_full()
                    io = KaitaiStream(BytesIO(self._raw_frame_data))
                    self.frame_data = self._root.Frame.FrameMain.CurvesNew(io, self, self._root)
                elif _on == self._root.Frame.FrameType.spectroscopy:
                    self._raw_frame_data = self._io.read_bytes_full()
                    io = KaitaiStream(BytesIO(self._raw_frame_data))
                    self.frame_data = self._root.Frame.FrameMain.Scanned(io, self, self._root)
                elif _on == self._root.Frame.FrameType.text:
                    self._raw_frame_data = self._io.read_bytes_full()
                    io = KaitaiStream(BytesIO(self._raw_frame_data))
                    self.frame_data = self._root.Frame.FrameMain.Text(io, self, self._root)
                elif _on == self._root.Frame.FrameType.curves:
                    self._raw_frame_data = self._io.read_bytes_full()
                    io = KaitaiStream(BytesIO(self._raw_frame_data))
                    self.frame_data = self._root.Frame.FrameMain.Scanned(io, self, self._root)
                elif _on == self._root.Frame.FrameType.metadata:
                    self._raw_frame_data = self._io.read_bytes_full()
                    io = KaitaiStream(BytesIO(self._raw_frame_data))
                    self.frame_data = self._root.Frame.FrameMain.MetaData(io, self, self._root)
                else:
            ...
            class CurvesNew(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    for i in range(self.block_count):
                        self.blocks_headers[i] = self._root.Frame.FrameMain.CurvesNew.BlockDescr(self._io, self, self._root)
            ...
            class MetaData(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    self.header = self._root.Frame.FrameMain.MetaData.Header(io, self, self._root)
                    ...
                    if self.header.spec_size != 0:
                        ...
                        io = KaitaiStream(BytesIO(self._raw_frame_spec))
                        self.frame_spec = self._root.Frame.FrameSpec(io, self, self._root)
                    ...
                    self.calibrations = self._root.Frame.FrameMain.MetaData.Calibrations(self._io, self, self._root)
                ...
                class Calibrations(KaitaiStruct):
                    ...
                    def _read(self):
                        ...
                        io = KaitaiStream(BytesIO(self._raw_header))
                        self.header = self._root.Frame.FrameMain.MetaData.Calibrations.Header(io, self, self._root)
                        self.dimensions = [None] * (self.header.n_dimensions)
                        for i in range(self.header.n_dimensions):
                            self.dimensions[i] = self._root.Frame.FrameMain.MetaData.Calibrations.Calibration(self._io, self, self._root)

                        self.mesurands = [None] * (self.header.n_mesurands)
                        for i in range(self.header.n_mesurands):
                            self.mesurands[i] = self._root.Frame.FrameMain.MetaData.Calibrations.Calibration(self._io, self, self._root)
                    ...
                    class Calibration(KaitaiStruct):
                        ...
                        def _read(self):
                            ...
                            self.internal = self._root.Frame.FrameMain.MetaData.Calibrations.Calibration.CalibrationInternal(self._io, self, self._root)
                        ...
                        class CalibrationInternal(KaitaiStruct):
                            ...
                            def _read(self):
                                ...
                                io = KaitaiStream(BytesIO(self._raw_header))
                                self.header = self._root.Frame.FrameMain.MetaData.Calibrations.Calibration.CalibrationInternal.Header(io, self, self._root)
                            ...
                            class Header(KaitaiStruct):
                                ...
                                def _read(self):
                                    ...
                                    self.unit_si_code = self._root.Frame.FrameMain.MetaData.Calibrations.Calibration.CalibrationInternal.Header.UnitSiCode(self._io.read_u8le())
                                    ...
                                    io = KaitaiStream(BytesIO(self._raw_min_index_placeholder))
                                    self.min_index_placeholder = self._root.Placeholder(io, self, self._root)
                                    self._raw_max_index_placeholder = self._io.read_bytes(8)
                                    io = KaitaiStream(BytesIO(self._raw_max_index_placeholder))
                                    self.max_index_placeholder = self._root.Placeholder(io, self, self._root)
                                ...
                                def min_index(self):
                                    ...
                                    _pos = io.pos()
                                    io.seek(0)
                                    self._m_min_index = self._root.Scalar(self.data_type.value, io, self, self._root)
                                    io.seek(_pos)
                                    return self._m_min_index if hasattr(self, '_m_min_index') else None
                                ...
                                def max_index(self):
                                    ...
                                    _pos = io.pos()
                                    io.seek(0)
                                    self._m_max_index = self._root.Scalar(self.data_type.value, io, self, self._root)
                                    io.seek(_pos)
                                    return self._m_max_index if hasattr(self, '_m_max_index') else None
                ...
                class Data(KaitaiStruct):
                    ...
                    def _read(self):
                        ...
                        while not self._io.is_eof():
                            self.values.append(self._root.Frame.FrameMain.MetaData.Data.Cell(self._io, self, self._root))
                            i += 1
                ...
                def data(self):
                    ...
                    self._m_data = self._root.Frame.FrameMain.MetaData.Data(io, self, self._root)
                    io.seek(_pos)
                    return self._m_data if hasattr(self, '_m_data') else None
            ...
            class Scanned(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    self.vars = self._root.Frame.FrameMain.Scanned.Vars(io, self, self._root)
                    if False:
                        self.orig_format = self._io.read_u4le()

                    if False:
                        self.tune = self._root.Frame.FrameMain.Scanned.LiftMode(self._io.read_u4le())
                    ...
                    self.data = self._root.Frame.FrameMain.Scanned.Data(self._io, self, self._root)
                    ...
                    if self._io.size() >= (self._io.pos() + 4):
                        self.frame_spec_with_size = self._root.Frame.FrameMain.Scanned.FrameSpecWithSize(self._io, self, self._root)

                    if self._io.size() >= (self._io.pos() + 4):
                        self.unkn1 = self._io.read_u4le()

                    if self._io.size() >= (self._io.pos() + 4):
                        self.additional_guids = self._root.Frame.AdditionalGuids(self._io, self, self._root)
                ...
                class Vars(KaitaiStruct):
                    ...
                    def _read(self):
                        self.scales = self._root.Frame.Scales(self._io, self, self._root)
                        _on = self._parent._parent.type
                        if _on == self._root.Frame.FrameType.scanned:
                            self.tvars = self._root.Frame.FrameMain.Scanned.Vars.Image(self._io, self, self._root)
                        elif _on == self._root.Frame.FrameType.spectroscopy:
                            self.tvars = self._root.Frame.FrameMain.Scanned.Vars.Curve(self._io, self, self._root)
                        elif _on == self._root.Frame.FrameType.curves:
                            self.tvars = self._root.Frame.FrameMain.Scanned.Vars.Curve(self._io, self, self._root)
                    ...
                    class Image(KaitaiStruct):
                        ...
                        def _read(self):
                            self.adc_mode = self._root.AdcMode(self._io.read_u1())
                            self.mode = self._root.Frame.FrameMain.Scanned.Mode(self._io.read_u1())
                            self.size = self._root.Vec2U2(self._io, self, self._root)
                            ...
                            self.scan_dir = self._root.Frame.FrameMain.Scanned.ScanDir(self._io, self, self._root)
                ...
                class Data(KaitaiStruct):
                    ...
                    def _read(self):
                        self.mode = self._io.read_u2le()
                        self.size = self._root.Vec2U2(self._io, self, self._root)
                        self.dots = self._root.Frame.FrameMain.Scanned.Data.Dots(self._io, self, self._root)
                    ...
                    class Dots(KaitaiStruct):
                        ...
                        def _read(self):
                            ...
                            if self.count > 0:
                                self.header = self._root.Frame.FrameMain.Scanned.Data.Dots.Header(self._io, self, self._root)

                            self.coordinates = [None] * (self.count)
                            for i in range(self.count):
                                self.coordinates[i] = self._root.Frame.FrameMain.Scanned.Data.Dots.Data(self._io, self, self._root)

                            self.data = [None] * (self.count)
                            for i in range(self.count):
                                self.data[i] = self._root.Frame.FrameMain.Scanned.Data.Dots.DataLine(i, self._io, self, self._root)
                        ...
                        class Header(KaitaiStruct):
                            ...
                            def _read(self):
                                ...
                                io = KaitaiStream(BytesIO(self._raw_header))
                                self.header = self._root.Frame.FrameMain.Scanned.Data.Dots.Header.Internal(io, self, self._root)
        ...
        class AdditionalGuids(KaitaiStruct):
            ...
            def _read(self):
                ...
                if self.size != 0:
                    ...
                    io = KaitaiStream(BytesIO(self._raw_guids))
                    self.guids = self._root.Frame.AdditionalGuids.Guids(io, self, self._root)
            ...
            class Guids(KaitaiStruct):
                ...
                def _read(self):
                    ...
                    i = 0
                    while not self._io.is_eof():
                        self.guids.append(self._root.Uuid(self._io, self, self._root))
                        i += 1
        ...
        class Scales(KaitaiStruct):
            ...
            def _read(self):
                self.scales = [None] * (3)
                for i in range(3):
                    self.scales[i] = self._root.Frame.Scales.AxisScale(self._io, self, self._root)
        ...
        class FrameSpec(KaitaiStruct):
            ...
            def _read(self):
                ...
                self.color_scheme = self._io.read_bytes_full()
